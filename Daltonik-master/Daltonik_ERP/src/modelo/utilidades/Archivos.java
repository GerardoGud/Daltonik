...
public Archivos(String ext) {
    this.archivoRuta="";
    this.setExtencion("."+ext);
    }
    ...
    public String AbrirArchivo(){
        ...
        if(opcion==JFileChooser.APPROVE_OPTION){
            ...
            code=dlgAbrir.getSelectedFile().getAbsolutePath();
        }else{
    ...
    public String GuardarXArchivo(){
        JFileChooser dlgGuardar=new JFileChooser();
        int opcion=dlgGuardar.showOpenDialog(null);
        dlgGuardar.setName("Guardar");
        dlgGuardar.setDialogType(1);
        String s;
